				                ...
				                <c:forEach var="role" items="${allRoles}">
				                	<tr id="${role.id}">
				                		...
				                		<td>
											...
											<a href="#" onclick="deleteRo('${role.id}')" class="btn btn-danger btn-xs" id="deleteRo"><span class="glyphicon glyphicon-remove"></span> 删除</a>
				                		</td>
				                	</tr>
				                </c:forEach>
	                    </tbody>
...
var deleteId;
 function deleteRo(deleteId){
	if(deleteId<6||deleteId=='0aeddab9-c1bb-4871-8f1c-68bc5f675fb0'||deleteId=='f7a38138-8210-4780-beef-aef49d40ab36'){
		alert("这个用户无法删除");
	}else {
		document.location.href="${pageContext.request.contextPath}/deleteRole?roleId="+deleteId;
	}
 };
</script>
