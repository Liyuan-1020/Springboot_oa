    	...
    	<div class="panel panel-default">
    		...
    		<div class="panel-body">
    			<div class="form-group">
                    ...
                    <button &lt;%&ndash;type="submit"&ndash;%&gt; class="btn btn-primary" id="aaa">保存角色和权限</button>
                </div>
    		</div>
    	</div>
        <div class="panel panel-default">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-success" data-dismiss="modal"
						aria-hidden="true" onclick="javascript:document.getElementById('permissionForm').submit()" id="test">保存</button>
